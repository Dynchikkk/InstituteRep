...
#include "E:/Xilinx/vhdl/hdp/nt/std/textio/textio.h"
#include "E:/Xilinx/vhdl/hdp/nt/ieee/std_logic_unsigned/std_logic_unsigned.h"
#include "E:/Xilinx/vhdl/hdp/nt/ieee/std_logic_textio/std_logic_textio.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_test_core_testbench_arch(const char*);
        topvh = createWork_test_core_testbench_arch("test_core");
