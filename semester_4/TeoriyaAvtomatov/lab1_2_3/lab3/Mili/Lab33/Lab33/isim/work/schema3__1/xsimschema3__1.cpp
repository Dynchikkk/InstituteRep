...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF7);
        ...
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("AND3B3", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF24);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF25);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF26);
