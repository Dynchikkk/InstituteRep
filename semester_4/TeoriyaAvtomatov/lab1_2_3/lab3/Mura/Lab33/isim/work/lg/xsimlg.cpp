...
va_list vap)
{
    extern HSim__s6 * createworkMlg(const char*);
    HSim__s6 *blk = createworkMlg(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createunisim_ver_auxlibM_a_n_d4_b4(const char*);
    HSim__s6 *blk = createunisim_ver_auxlibM_a_n_d4_b4(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createunisim_ver_auxlibM_a_n_d5_b4(const char*);
    HSim__s6 *blk = createunisim_ver_auxlibM_a_n_d5_b4(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createworkMschema3__1(const char*);
    HSim__s6 *blk = createworkMschema3__1(label); 
    return blk;
}
...
static HSim__s6* IF39(HSim__s6 *Arch,const char* label,int nGenerics,va_list vap)
{
    extern HSim__s6* createWork_flip_flop_rs_behavioral(const char*);
    HSim__s6 *blk = createWork_flip_flop_rs_behavioral(label);
    return blk;
}


static HSim__s6* IF40(HSim__s6 *Arch,const char* label,int nGenerics,va_list vap)
{
    extern HSim__s6* createWork_flip_flop_rs_behavioral(const char*);
    HSim__s6 *blk = createWork_flip_flop_rs_behavioral(label);
    return blk;
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("lg", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("AND4", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("AND4B1", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("AND4B2", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("AND4B4", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("AND5B4", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("OR5", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("OR5", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF24);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF25);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF26);
        (*cfgvh).addVlogModule("AND5B4", (HSimInstFactoryPtr)IF27);
        (*cfgvh).addVlogModule("AND4B4", (HSimInstFactoryPtr)IF28);
        (*cfgvh).addVlogModule("AND4B2", (HSimInstFactoryPtr)IF29);
        (*cfgvh).addVlogModule("AND4B1", (HSimInstFactoryPtr)IF30);
        (*cfgvh).addVlogModule("AND4", (HSimInstFactoryPtr)IF31);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF32);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF33);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF34);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF35);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF36);
        (*cfgvh).addVlogModule("schema3_1", (HSimInstFactoryPtr)IF37);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF38);
        (*cfgvh).addVlogModule("flip_flop_rs/behavioral", (HSimInstFactoryPtr)IF39, true);
        (*cfgvh).addVlogModule("flip_flop_rs", (HSimInstFactoryPtr)IF40, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMlg(const char*);
        topvl = (HSim__s5*)createworkMlg("lg");
