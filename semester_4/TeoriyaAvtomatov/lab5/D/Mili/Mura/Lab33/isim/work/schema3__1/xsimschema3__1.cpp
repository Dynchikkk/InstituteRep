...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("schema3_1", (HSimInstFactoryPtr)IF0);
        ...
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("flip_flop_rs/behavioral", (HSimInstFactoryPtr)IF24, true);
        (*cfgvh).addVlogModule("flip_flop_rs", (HSimInstFactoryPtr)IF25, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMschema3__1(const char*);
        topvl = (HSim__s5*)createworkMschema3__1("schema3_1");
