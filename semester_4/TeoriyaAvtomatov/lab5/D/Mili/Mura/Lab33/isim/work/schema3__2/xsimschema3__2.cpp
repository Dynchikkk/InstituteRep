...
va_list vap)
{
    extern HSim__s6 * createworkMschema3__2(const char*);
    HSim__s6 *blk = createworkMschema3__2(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("schema3_2", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("AND3B3", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("AND3B3", (HSimInstFactoryPtr)IF24);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF25);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF26);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF27);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF28);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF29);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMschema3__2(const char*);
        topvl = (HSim__s5*)createworkMschema3__2("schema3_2");
