...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("schema3_1", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("flip_flop_rs/behavioral", (HSimInstFactoryPtr)IF21, true);
        (*cfgvh).addVlogModule("flip_flop_rs", (HSimInstFactoryPtr)IF22, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMlg(const char*);
