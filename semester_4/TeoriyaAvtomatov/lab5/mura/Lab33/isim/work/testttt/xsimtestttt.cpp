...
va_list vap)
{
    extern HSim__s6 * createworkMtestttt(const char*);
    HSim__s6 *blk = createworkMtestttt(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createunisim_ver_auxlibM_o_r2_b1(const char*);
    HSim__s6 *blk = createunisim_ver_auxlibM_o_r2_b1(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createunisim_ver_auxlibM_x_o_r2(const char*);
    HSim__s6 *blk = createunisim_ver_auxlibM_x_o_r2(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("testttt", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("OR2B1", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("XOR2", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("XOR2", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("OR2B1", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("schema3_1", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("flip_flop_rs/behavioral", (HSimInstFactoryPtr)IF23, true);
        (*cfgvh).addVlogModule("flip_flop_rs", (HSimInstFactoryPtr)IF24, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMtestttt(const char*);
        topvl = (HSim__s5*)createworkMtestttt("testttt");
