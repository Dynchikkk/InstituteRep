...
va_list vap)
{
    extern HSim__s6 * createworkMwww(const char*);
    HSim__s6 *blk = createworkMwww(label); 
    return blk;
}
...
va_list vap)
{
    extern HSim__s6 * createunisim_ver_auxlibM_a_n_d3_b3(const char*);
    HSim__s6 *blk = createunisim_ver_auxlibM_a_n_d3_b3(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("www", (HSimInstFactoryPtr)IF0);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF1);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("AND3B3", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("AND4B1", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("AND4B3", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("AND4B1", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("AND3B3", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("AND3B2", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("AND3", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("schema3_1", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF24);
        (*cfgvh).addVlogModule("flip_flop_rs/behavioral", (HSimInstFactoryPtr)IF25, true);
        (*cfgvh).addVlogModule("flip_flop_rs", (HSimInstFactoryPtr)IF26, true);
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMwww(const char*);
        topvl = (HSim__s5*)createworkMwww("www");
