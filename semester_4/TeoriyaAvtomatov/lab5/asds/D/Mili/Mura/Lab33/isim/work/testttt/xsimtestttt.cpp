...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("OR4", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("OR3", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("OR2", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("OBUF", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("IBUFG", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("IBUF", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("FDC", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("BUF", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("AND3B1", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("AND2B1", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("AND2", (HSimInstFactoryPtr)IF22);
