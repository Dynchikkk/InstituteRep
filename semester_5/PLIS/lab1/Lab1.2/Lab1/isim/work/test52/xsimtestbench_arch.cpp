...
#include "C:/Xilinx91i/vhdl/hdp/nt/ieee/numeric_std/numeric_std.h"
#include "C:/Xilinx91i/vhdl/hdp/nt/ieee/std_logic_textio/std_logic_textio.h"
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_test52_testbench_arch(const char*);
        topvh = createWork_test52_testbench_arch("test52");
