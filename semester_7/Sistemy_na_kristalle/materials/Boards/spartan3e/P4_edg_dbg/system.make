...
# F:\zRabG\Xlnx\UPR2007\P4_edg_dbg\system.mhs
# The software specification of the system is in file :
# F:\zRabG\Xlnx\UPR2007\P4_edg_dbg\system.mss
...
$(SYSTEM_ACE): $(DOWNLOAD_BIT) $(TESTAPP_MEMORY_OUTPUT) 
	...
	@echo "*********************************************"
	xmd -tcl genace.tcl -jprog -hw $(DOWNLOAD_BIT) -elf $(TESTAPP_MEMORY_OUTPUT)  -target mdm  -ace $(SYSTEM_ACE)
