...
va_list vap)
{
    extern HSim__s6 * createworkMtb1(const char*);
    HSim__s6 *blk = createworkMtb1(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("tb1", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkMtb1(const char*);
        topvl = (HSim__s5*)createworkMtb1("tb1");
