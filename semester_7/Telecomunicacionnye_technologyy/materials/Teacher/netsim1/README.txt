...
Version:        Public Release Version 0.33
...
1.      If you do not have the Java Runtime Environment (JRE) installed on your Operating System, the program will not be 
        able to run. You must install the Java Runtime Environment 1.6.0_01 or later. This can be downloaded from www.java.com
...
2.      If you have downloaded the pre-compiled zip version, find where you extracted the contents and run windows.bat/linux.sh
        ...
        Note: The Java Network Simulator has only been fully tested under WinXP/WinVista and Linux (Gentoo/Fedora). 
...
GUI Issues -
    ...
    1. Fixed Java 6 related bugs with some diaglogs.
