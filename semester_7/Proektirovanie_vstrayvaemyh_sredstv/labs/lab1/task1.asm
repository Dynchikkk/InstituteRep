    list        p=16f887        ; целевой микроконтроллер
...
INT_VECTOR      CODE    0x0004 ; вектор прерывания
    ...
    movwf   STATUS
    swapf   w_temp,f          ; меняет местами стар/млад нибблы w_temp и сохраняет в w_temp
...
start
	...
	movwf PORTD                 ; записать 0x55 (01010101) в PORTD — начальное состояние портD
